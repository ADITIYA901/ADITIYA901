...
import { Vote, Check, Eye, EyeOff, Mail, Lock } from 'lucide-react';
      ...
      <div className="gradient-bg flex-1 flex items-center justify-center p-8 lg:p-16 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-white/70 text-lg mb-10">
            Cast your vote securely on the blockchain. Every vote is encrypted, immutable, and verifiable.
          </p>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-2 text-dark-500 dark:text-dark-400">
              Sign in to cast your vote securely
            </p>
          </div>
